import{C as u,a as d}from"./index-WipdELyR.js";import{l as p,L as l,m as c}from"./index-CimbCcJO.js";import{C as b,W as g,S as f,a as h,f as w,F as y}from"./index-B3o0n-Ei.js";const v=document.getElementById("container"),o=new b,L=o.get(g),e=L.create();e.scene=new f(o);e.renderer=new h(o,v);e.camera=new w(o);o.init();e.scene.setup();e.scene.three.background=null;const k="https://thatopen.github.io/engine_fragment/resources/worker.mjs",C=await fetch(k),S=await C.blob(),U=new File([S],"worker.mjs",{type:"text/javascript"}),j=URL.createObjectURL(U),n=o.get(y);n.init(j);e.camera.controls.addEventListener("rest",()=>n.core.update(!0));n.list.onItemSet.add(({value:t})=>{t.useCamera(e.camera.three),e.scene.three.add(t.object),n.core.update(!0)});const x=["https://thatopen.github.io/engine_components/resources/frags/school_arq.frag"];await Promise.all(x.map(async t=>{var i;const s=(i=t.split("/").pop())==null?void 0:i.split(".").shift();if(!s)return null;const m=await(await fetch(t)).arrayBuffer();return n.core.load(m,{modelId:s})}));await e.camera.controls.setLookAt(68,23,-8.5,21.5,-5.5,23);await n.core.update(!0);p.init();const r=l.create(()=>c`
    ...
    `);document.body.append(r);const B=l.create(()=>c`
