import{a as p}from"./index-WipdELyR.js";import{l as b,L as m,m as d}from"./index-CimbCcJO.js";import{C as u,W as h,S as f,a as g,O as w,F as v}from"./index-B3o0n-Ei.js";import{G as k}from"./index-oDbgpygJ.js";const n=new u,P=n.get(h),e=P.create();e.scene=new f(n);e.scene.setup();e.scene.three.background=null;const F=document.getElementById("container");e.renderer=new g(n,F);e.camera=new w(n);await e.camera.controls.setLookAt(68,23,-8.5,21.5,-5.5,23);n.init();const j=n.get(k).create(e),O="https://thatopen.github.io/engine_fragment/resources/worker.mjs",y=await fetch(O),C=await y.blob(),L=new File([C],"worker.mjs",{type:"text/javascript"}),U=URL.createObjectURL(L),r=n.get(v);r.init(U);e.camera.controls.addEventListener("rest",()=>r.core.update(!0));e.onCameraChanged.add(t=>{for(const[,o]of r.list)o.useCamera(t.three);r.core.update(!0)});r.list.onItemSet.add(({value:t})=>{t.useCamera(e.camera.three),e.scene.three.add(t.object),r.core.update(!0)});const I=["https://thatopen.github.io/engine_components/resources/frags/school_arq.frag"];await Promise.all(I.map(async t=>{var l;const o=(l=t.split("/").pop())==null?void 0:l.split(".").shift();if(!o)return null;const s=await(await fetch(t)).arrayBuffer();return r.core.load(s,{modelId:o})}));e.camera.projection.onChanged.add(()=>{const t=e.camera.projection.current;j.fade=t==="Perspective"});b.init();const c=m.create(()=>d`
