import{u as O,V as C,J as B,f as k,a as A,S as x,aQ as D}from"./index-BVinSk0X.js";import{C as q,W as P,S as T,a as R,O as W,F as j,e as z,D as E}from"./index-DBG1qVuX.js";const d=new q,G=d.get(P),n=G.create();n.scene=new T(d);n.scene.setup();n.scene.three.background=null;const U=document.getElementById("container");n.renderer=new R(d,U);n.camera=new W(d);await n.camera.controls.setLookAt(78,20,-2.2,26,-4,25);d.init();const _="/node_modules/fragments-beta/dist/Worker/worker.mjs",s=d.get(j);s.init(_);n.camera.controls.addEventListener("rest",()=>s.core.update(!0));n.onCameraChanged.add(e=>{for(const[,o]of s.list)o.useCamera(e.three);s.core.update(!0)});s.list.onItemSet.add(({value:e})=>{e.useCamera(n.camera.three),n.scene.three.add(e.object),s.core.update(!0)});const V=["/resources/frags/school_arq.frag","/resources/frags/school_str.frag"];await Promise.all(V.map(async e=>{var p;const o=(p=e.split("/").pop())==null?void 0:p.split(".").shift();if(!o)return null;const l=await(await fetch(e)).arrayBuffer();return s.core.load(l,{modelId:o})}));const c=d.get(z),I=()=>{c.list.clear(),c.addFromModels();const e=c.get();return c.list.clear(),e},S=async e=>{const o=[...s.list.keys()].find(h=>/arq/.test(h));if(!o)return null;const i=s.list.get(o);if(!i)return null;const l=await i.getItemsOfCategories([new RegExp(`^${e}$`)]),f=Object.values(l).flat().slice(0,1),g={[o]:new Set(f)};c.list.clear(),await c.addFromModelIdMap(g);const w=c.get();return c.list.clear(),w},J=async e=>{const o=n.camera;if(!o.hasCameraControls())return;const{position:i,target:l}=await c.getCameraOrientation(e);await o.controls.setLookAt(i.x,i.y,i.z,l.x,l.y,l.z,!0)};let v=[];const $=e=>{const o=new D(e);n.scene.three.add(o),v.push(o)},Q=()=>{const e=d.get(E);for(const o of v)e.destroy(o);v=[]};O.init();const u=C.create(()=>{let e,o;const i=({target:t})=>{t.loading=!0;const r=I(),a=new x;r.getBoundingSphere(a),n.camera.controls.fitToSphere(a,!0),t.loading=!1},l=()=>{const t=I();$(t)},p=async({target:t})=>{if(!e)return;t.loading=!0;const[r]=e.value,a=await S(r);if(!a){t.loading=!1;return}$(a),t.loading=!1},f=async t=>{if(!t)return;const r=[...s.list.keys()].find(y=>/arq/.test(y));if(!r)return;const a=s.list.get(r);if(!a)return;const m=t;e=m,m.innerHTML="";const F=await a.getItemsWithGeometryCategories();for(const[y,H]of F.entries()){const L=C.create(()=>k`<bim-option ?checked=${y===0} label=${H}></bim-option>`);m.append(L)}},g=async({target:t})=>{if(!e)return;t.loading=!0;const[r]=e.value,a=await S(r);if(!a){t.loading=!1;return}const m=new x;a.getBoundingSphere(m),n.camera.controls.fitToSphere(m,!0),t.loading=!1},w=()=>{Q()},h=t=>{t&&(o=t)},M=async({target:t})=>{if(!o)return;t.loading=!0;const[r]=o.value;await J(r),t.loading=!1};return k`
