var $=Object.defineProperty;var S=(o,t,e)=>t in o?$(o,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[t]=e;var r=(o,t,e)=>(S(o,typeof t!="symbol"?t+"":t,e),e);import{C as g,S as E,h as x,U as _,f as m,a as M}from"./index-NQd5NlAY.js";import{M as f,R as L,C as P,W as I,S as B,O as H,F as D}from"./graphic-vertex-picker-EcW201oD.js";import{P as U}from"./index-BzXyTyuA.js";import{M as V,a as j}from"./index-RwqI3FxQ.js";import{H as A}from"./index-C1gOa3Ed.js";import"./index-Dy05kM8s.js";const p=class p extends V{constructor(e){super(e,"volume");r(this,"_temp",{});r(this,"modes",["free"]);r(this,"_mode","free");r(this,"_previousHovererState",!1);r(this,"create",async()=>{if(!this.enabled)return;const e=await this._vertexPicker.get();e&&(this._temp.preview||await this.initPreview(),this._temp.preview.volume.items=f.join([this._temp.preview.volume.items,{[e.fragments.modelId]:new Set([e.localId])}]))});r(this,"endCreation",()=>{if(!this._temp.preview||f.isEmpty(this._temp.preview.volume.items))return;const e=this._temp.preview.volume.clone();this.list.add(e),this._temp.preview.dispose(),delete this._temp.preview});r(this,"cancelCreation",()=>{var e;(e=this._temp.preview)==null||e.dispose(),delete this._temp.preview});r(this,"delete",async()=>{if(this.list.size===0||!this.world)return;const e=await this.getVolumeBoxes(),a=this.components.get(L).get(this.world);for(const b of e){const v=a.castRayToObjects(b);if(!v)continue;const w=[...this.volumes].find(y=>y.meshes.some(C=>C===v.object));if(!w)return;this.list.delete(w.volume)}});e.add(p.uuid,this),this.initHandlers()}get mode(){return this._mode}set mode(e){this._mode=e,this.cancelCreation(),this.onStateChanged.trigger(["mode"])}initHandlers(){this.list.onItemAdded.add(e=>{const n=this.createVolumeElement(e);n.color=this.color,n.rounding=this.rounding,n.units=this.units,this.volumes.add(n)}),this.list.onBeforeDelete.add(e=>{const a=[...this.volumes].find(b=>b.volume===e);a&&this.volumes.delete(a)}),this.onStateChanged.add(e=>{if(e.includes("color")){if(!this._temp.preview)return;this._temp.preview.color=this.color}if(e.includes("units")){if(!this._temp.preview)return;this._temp.preview.units=this.units}if(e.includes("rounding")){if(!this._temp.preview)return;this._temp.preview.rounding=this.rounding}if(e.includes("enabled")){const n=this.components.get(A);n.world=this.world,this.enabled?(this._previousHovererState=n.enabled,n.enabled=!0):(n.clear(),n.enabled=this._previousHovererState),n.hover()}})}async initPreview(){if(this.enabled){if(!this.world)throw new Error("Measurement: world is need!");this._temp.preview=new j(this.components,this.world),this._temp.preview.color=this.color,this._temp.preview.rounding=this.rounding,this._temp.preview.units=this.units}}};r(p,"uuid","01f885ab-ec4e-4e6c-a853-9dfc0d6766ed");let h=p;const c=new P,R=c.get(I),s=R.create();s.scene=new B(c);s.scene.setup();s.scene.three.background=null;const k=document.getElementById("container");s.renderer=new U(c,k);s.camera=new H(c);await s.camera.controls.setLookAt(68,23,-8.5,21.5,-5.5,23);c.init();const q="https://thatopen.github.io/engine_fragment/resources/worker.mjs",l=c.get(D);l.init(q);s.camera.controls.addEventListener("rest",()=>l.core.update(!0));s.onCameraChanged.add(o=>{for(const[,t]of l.list)t.useCamera(o.three);l.core.update(!0)});l.list.onItemSet.add(({value:o})=>{o.useCamera(s.camera.three),s.scene.three.add(o.object),l.core.update(!0)});const O=["https://thatopen.github.io/engine_components/resources/frags/school_arq.frag"];await Promise.all(O.map(async o=>{var a;const t=(a=o.split("/").pop())==null?void 0:a.split(".").shift();if(!t)return null;const n=await(await fetch(o)).arrayBuffer();return l.core.load(n,{modelId:t})}));const i=c.get(h);i.world=s;i.color=new g("#494cb6");i.enabled=!0;k.ondblclick=()=>i.create();window.addEventListener("keydown",o=>{(o.code==="Enter"||o.code==="NumpadEnter")&&i.endCreation()});const T=()=>{i.list.clear()},z=async()=>{const o=[];for(const t of i.list){const e=await t.getValue();o.push(e)}return o};window.onkeydown=o=>{(o.code==="Delete"||o.code==="Backspace")&&i.delete()};i.list.onItemAdded.add(async o=>{const t=await o.getBox(),e=new E;t.getBoundingSphere(e),s.camera.controls.fitToSphere(e,!0)});x.init();const u=_.create(()=>{const o=async({target:t})=>{t.loading=!0;const e=await z();console.log(e),t.loading=!1};return m`
  ...
  `});document.body.append(u);const F=_.create(()=>m`
    ...
    `);document.body.append(F);const d=new M;d.showPanel(2);document.body.append(d.dom);d.dom.style.left="0px";d.dom.style.zIndex="unset";s.renderer.onBeforeUpdate.add(()=>d.begin());s.renderer.onAfterUpdate.add(()=>d.end());
