var P=Object.defineProperty;var C=(i,t,e)=>t in i?P(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var r=(i,t,e)=>(C(i,typeof t!="symbol"?t+"":t,e),e);import{b as w,C as _,O as $,S as E,u as k,V as v,f as p,a as L}from"./index-BVinSk0X.js";import{R as x,C as S,W as B,S as M,O as j,F as I}from"./graphic-vertex-picker-DflXmoKw.js";import{P as V}from"./index-B6fiNTvg.js";import{M as O,L as A}from"./index-DYU-cPhX.js";import"./index-DoQFoArG.js";const h=class h extends O{constructor(e){super(e,"length");r(this,"_temp",{isDragging:!1,line:new A});r(this,"modes",["free","edge"]);r(this,"_mode","free");r(this,"create",()=>{if(this.enabled){if(!this._temp.isDragging){this.initPreview();return}this.endCreation()}});r(this,"endCreation",()=>{this.enabled&&this._temp.dimension&&(this.list.add(this._temp.line.clone()),this.mode==="free"&&(this._temp.dimension.dispose(),this._temp.dimension=void 0,this._temp.isDragging=!1,this._temp.startNormal=void 0))});r(this,"cancelCreation",()=>{var e;this.enabled&&(this._temp.isDragging=!1,this._temp.dimension&&((e=this._temp.dimension)==null||e.dispose(),this._temp.dimension=void 0))});r(this,"delete",()=>{if(!this.enabled||this.list.size===0||!this.world)return;const e=this.getLineBoxes(),l=this.components.get(x).get(this.world).castRayToObjects(e);if(!l)return;const f=[...this.lines].find(y=>y.boundingBox===l.object);f&&this.list.delete(f.line)});e.add(h.uuid,this),this.initHandlers()}get mode(){return this._mode}set mode(e){this._mode=e,this.cancelCreation(),e==="edge"&&this.initPreview(),this.onStateChanged.trigger(["mode"])}initHandlers(){this.list.onItemAdded.add(e=>{const s=this.createLineElement(e,this._temp.startNormal);s.createBoundingBox(),this.lines.add(s)}),this.list.onBeforeDelete.add(e=>{const a=[...this.lines].find(l=>l.line===e);a&&this.lines.delete(a)}),this.onPointerStop.add(()=>this.updatePreviewLine()),this.onEnabledChange.add(e=>{e&&this.mode==="edge"&&this.initPreview()})}async initPreview(){if(!this.world)throw new Error("Measurement: world is need!");const e=await this._vertexPicker.get({snappingClasses:this.snappings});if(this.mode==="free"){if(!(e!=null&&e.point))return;const s=e.point;this._temp.line.set(s,s.clone()),this._temp.isDragging=!0,this._temp.dimension=this.createLineElement(this._temp.line),this._temp.startNormal=e.normal??void 0}else if(this.mode==="edge"){const s=e==null?void 0:e.snappedEdgeP1,a=e==null?void 0:e.snappedEdgeP2,l=s||new w,g=l||a;this._temp.line.set(l,g),this._temp.isDragging=!0,this._temp.dimension=this.createLineElement(this._temp.line),this._temp.dimension.visible=!!(s&&a)}}async updatePreviewLine(){if(!this.world)throw new Error("Measurement: world is need!");const e=await this._vertexPicker.get({snappingClasses:this.snappings});if(this.mode==="free"){if(!(e!=null&&e.point)||(this._temp.line.end.copy(e.point),!this._temp.dimension))return;this._temp.dimension.end=this._temp.line.end}else if(this.mode==="edge"){const s=e==null?void 0:e.snappedEdgeP1,a=e==null?void 0:e.snappedEdgeP2;if(this._temp.dimension&&(this._temp.dimension.visible=!!(s&&a)),!(s&&a)||(this._temp.line.start.copy(s),this._temp.line.end.copy(a),!this._temp.dimension))return;this._temp.dimension.start=this._temp.line.start,this._temp.dimension.end=this._temp.line.end}}};r(h,"uuid","2f9bcacf-18a9-4be6-a293-e898eae64ea1");let u=h;const d=new S,q=d.get(B),o=q.create();o.scene=new M(d);o.scene.setup();o.scene.three.background=null;const D=document.getElementById("container");o.renderer=new V(d,D);o.camera=new j(d);await o.camera.controls.setLookAt(68,23,-8.5,21.5,-5.5,23);d.init();const N="/node_modules/@thatopen-platform/fragments-beta/dist/Worker/worker.mjs",m=d.get(I);m.init(N);o.camera.controls.addEventListener("rest",()=>m.core.update(!0));o.onCameraChanged.add(i=>{for(const[,t]of m.list)t.useCamera(i.three);m.core.update(!0)});m.list.onItemSet.add(({value:i})=>{i.useCamera(o.camera.three),o.scene.three.add(i.object),m.core.update(!0)});const T=["/resources/frags/school_arq.frag"];await Promise.all(T.map(async i=>{var a;const t=(a=i.split("/").pop())==null?void 0:a.split(".").shift();if(!t)return null;const s=await(await fetch(i)).arrayBuffer();return m.core.load(s,{modelId:t})}));const n=d.get(u);n.world=o;n.color=new _("#494cb6");n.enabled=!0;n.snappings=[$.POINT];D.ondblclick=()=>n.create();const U=()=>{n.list.clear()},H=()=>{const i=[];for(const t of n.list)i.push(t.value);return i};window.onkeydown=i=>{(i.code==="Delete"||i.code==="Backspace")&&n.delete()};n.list.onItemAdded.add(i=>{const t=new w;i.getCenter(t);const e=i.distance()/3,s=new E(t,e);o.camera.controls.fitToSphere(s,!0)});const W=()=>{for(const i of n.lines)i.displayRectangularDimensions()},z=()=>{for(const i of n.lines)i.invertRectangularDimensions()},F=()=>{for(const i of n.lines)i.displayProjectionDimensions()},R=()=>{for(const i of n.lines)i.rectangleDimensions.clear(),i.projectionDimensions.clear()};k.init();const b=v.create(()=>{const i=()=>{const t=H();console.log(t)};return p`
    <bim-panel active label="Length Measurement Tutorial" class="options-menu">
      ...
      <bim-panel-section label="Measurer">
        ...
        <bim-button label="Invert Rectangle Dimensions" @click=${z}></bim-button>

        <bim-button label="Display Projection Dimensions" @click=${F}></bim-button>
  ...
  `});document.body.append(b);const G=v.create(()=>p`
