import{u as f,V as p,f as m,C as g,a as v}from"./index-BVinSk0X.js";import{C as h,W as w,S as y,a as C,O as S,F as G}from"./index-DBG1qVuX.js";import{G as k}from"./index-C6-W7G3U.js";const r=new h,I=r.get(w),n=I.create();n.scene=new y(r);n.scene.setup();n.scene.three.background=null;const L=document.getElementById("container");n.renderer=new C(r,L);n.camera=new S(r);await n.camera.controls.setLookAt(68,23,-8.5,21.5,-5.5,23);r.init();const $="/node_modules/fragments-beta/dist/Worker/worker.mjs",a=r.get(G);a.init($);n.camera.controls.addEventListener("rest",()=>a.core.update(!0));n.onCameraChanged.add(t=>{for(const[,e]of a.list)e.useCamera(t.three);a.core.update(!0)});a.list.onItemSet.add(({value:t})=>{t.useCamera(n.camera.three),n.scene.three.add(t.object),a.core.update(!0)});const E=["/resources/frags/school_arq.frag"],[d]=await Promise.all(E.map(async t=>{var u;const e=(u=t.split("/").pop())==null?void 0:u.split(".").shift();if(!e)return null;const o=await(await fetch(t)).arrayBuffer();return a.core.load(o,{modelId:e})})),N=r.get(k),l=N.create(n),x=await d.getItemsOfCategories([/BUILDINGSTOREY/]),z=Object.values(x).flat(),b=await d.getItemsData(z),O=async t=>{const e=b.find(o=>"Name"in o&&"value"in o.Name?o.Name.value===t:!1);if(!e||!("Elevation"in e&&"value"in e.Elevation))return 0;const[,s]=await d.getCoordinates();return e.Elevation.value+s};f.init();const c=p.create(()=>m`
