<<<<<<<< HEAD:examples/assets/index-B5zN88tx.js
var g=Object.defineProperty;var p=(s,i,e)=>i in s?g(s,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[i]=e;var t=(s,i,e)=>(p(s,typeof i!="symbol"?i+"":i,e),e);import{g as v,E as a,h as z,D as S,f as n,d as _}from"./index-DBuLIbgE.js";import{C as u,ar as y,t as w,D as b,b as C}from"./index-NQd5NlAY.js";class x extends v{constructor(){super(...arguments);t(this,"_config",{visible:{value:!0,type:"Boolean"},color:{value:new u,type:"Color"},primarySize:{type:"Number",interpolable:!0,value:1,min:0,max:1e3},secondarySize:{type:"Number",interpolable:!0,value:10,min:0,max:1e3},distance:{type:"Number",interpolable:!0,value:500,min:0,max:500}})}get visible(){return this._config.visible.value}set visible(e){this._config.visible.value=e,this._component.visible=e}get color(){return this._config.color.value}set color(e){this._config.color.value=e,this._component.material.uniforms.uColor.value=e,this._component.material.uniformsNeedUpdate=!0}get primarySize(){return this._config.primarySize.value}set primarySize(e){this._config.primarySize.value=e,this._component.material.uniforms.uSize1.value=e,this._component.material.uniformsNeedUpdate=!0}get secondarySize(){return this._config.secondarySize.value}set secondarySize(e){this._config.secondarySize.value=e,this._component.material.uniforms.uSize2.value=e,this._component.material.uniformsNeedUpdate=!0}get distance(){return this._config.distance.value}set distance(e){this._config.distance.value=e,this._component.material.uniforms.uDistance.value=e,this._component.material.uniformsNeedUpdate=!0}}class D{constructor(i,e){t(this,"onDisposed",new a);t(this,"onSetup",new a);t(this,"isSetup",!1);t(this,"world");t(this,"components");t(this,"config");t(this,"_defaultConfig",{visible:!0,color:new u(12303291),primarySize:1,secondarySize:10,distance:500});t(this,"three");t(this,"_fade",3);t(this,"updateZoom",()=>{this.world.camera instanceof n&&(this.material.uniforms.uZoom.value=this.world.camera.three.zoom)});this.world=e;const{color:o,primarySize:d,secondarySize:c,distance:m}=this._defaultConfig;this.components=i,this.config=new x(this,this.components,"Grid");const h=new y(2,2,1,1),f=new w({side:b,uniforms:{uSize1:{value:d},uSize2:{value:c},uColor:{value:o},uDistance:{value:m},uFade:{value:this._fade},uZoom:{value:1}},transparent:!0,vertexShader:`
========
var g=Object.defineProperty;var p=(s,i,e)=>i in s?g(s,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[i]=e;var t=(s,i,e)=>(p(s,typeof i!="symbol"?i+"":i,e),e);import{g as v,E as a,h as z,D as S,f as n,d as _}from"./index-B31d80Z1.js";import{C as u,ar as y,v as w,D as b,d as C}from"./index-BET5fVdQ.js";class x extends v{constructor(){super(...arguments);t(this,"_config",{visible:{value:!0,type:"Boolean"},color:{value:new u,type:"Color"},primarySize:{type:"Number",interpolable:!0,value:1,min:0,max:1e3},secondarySize:{type:"Number",interpolable:!0,value:10,min:0,max:1e3},distance:{type:"Number",interpolable:!0,value:500,min:0,max:500}})}get visible(){return this._config.visible.value}set visible(e){this._config.visible.value=e,this._component.visible=e}get color(){return this._config.color.value}set color(e){this._config.color.value=e,this._component.material.uniforms.uColor.value=e,this._component.material.uniformsNeedUpdate=!0}get primarySize(){return this._config.primarySize.value}set primarySize(e){this._config.primarySize.value=e,this._component.material.uniforms.uSize1.value=e,this._component.material.uniformsNeedUpdate=!0}get secondarySize(){return this._config.secondarySize.value}set secondarySize(e){this._config.secondarySize.value=e,this._component.material.uniforms.uSize2.value=e,this._component.material.uniformsNeedUpdate=!0}get distance(){return this._config.distance.value}set distance(e){this._config.distance.value=e,this._component.material.uniforms.uDistance.value=e,this._component.material.uniformsNeedUpdate=!0}}class D{constructor(i,e){t(this,"onDisposed",new a);t(this,"onSetup",new a);t(this,"isSetup",!1);t(this,"world");t(this,"components");t(this,"config");t(this,"_defaultConfig",{visible:!0,color:new u(12303291),primarySize:1,secondarySize:10,distance:500});t(this,"three");t(this,"_fade",3);t(this,"updateZoom",()=>{this.world.camera instanceof n&&(this.material.uniforms.uZoom.value=this.world.camera.three.zoom)});this.world=e;const{color:o,primarySize:d,secondarySize:c,distance:m}=this._defaultConfig;this.components=i,this.config=new x(this,this.components,"Grid");const h=new y(2,2,1,1),f=new w({side:b,uniforms:{uSize1:{value:d},uSize2:{value:c},uColor:{value:o},uDistance:{value:m},uFade:{value:this._fade},uZoom:{value:1}},transparent:!0,vertexShader:`
>>>>>>>> upstream/main:examples/assets/index-DFO-Vypy.js
