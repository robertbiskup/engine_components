import{a as f}from"./index-WipdELyR.js";import{l as g,L as u,m as l}from"./index-CimbCcJO.js";import{C as h,W as w,S as k,a as L,O as y,F}from"./index-B3o0n-Ei.js";import{G as I}from"./index-oDbgpygJ.js";const r=new h,U=r.get(w),t=U.create();t.scene=new k(r);t.scene.setup();t.scene.three.background=null;const v=document.getElementById("container");t.renderer=new L(r,v);t.camera=new y(r);await t.camera.controls.setLookAt(78,20,-2.2,26,-4,25);r.init();r.get(I).create(t);const B="https://thatopen.github.io/engine_fragment/resources/worker.mjs",M=await fetch(B),$=await M.blob(),j=new File([$],"worker.mjs",{type:"text/javascript"}),A=URL.createObjectURL(j),e=r.get(F);e.init(A);t.camera.controls.addEventListener("rest",()=>e.core.update(!0));e.list.onItemSet.add(({value:o})=>{o.useCamera(t.camera.three),t.scene.three.add(o.object),e.core.update(!0)});const R=async()=>{const o=["https://thatopen.github.io/engine_components/resources/frags/school_arq.frag","https://thatopen.github.io/engine_components/resources/frags/school_str.frag"];await Promise.all(o.map(async s=>{var c;const n=(c=s.split("/").pop())==null?void 0:c.split(".").shift();if(!n)return null;const d=await(await fetch(s)).arrayBuffer();return e.core.load(d,{modelId:n})}))},S=async()=>{for(const[,o]of e.list){const s=await o.getBuffer(!1),n=new File([s],`${o.modelId}.frag`),a=document.createElement("a");a.href=URL.createObjectURL(n),a.download=n.name,a.click(),URL.revokeObjectURL(a.href)}},_=()=>{const s=[...e.list.keys()].find(n=>/arq/.test(n));s&&e.core.disposeModel(s)},C=()=>{for(const[o]of e.list)e.core.disposeModel(o)};g.init();const[p,O]=u.create(o=>{const s=async({target:m})=>{m.loading=!0,await R(),m.loading=!1};let n;e.list.size===0&&(n=l`
