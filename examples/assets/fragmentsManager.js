import{u as p,V as f,f as l,a as g}from"./index-BVinSk0X.js";import{C as w,W as h,S as k,a as y,O as I,F as L}from"./index-DBG1qVuX.js";import{G as F}from"./index-C6-W7G3U.js";const r=new w,M=r.get(h),t=M.create();t.scene=new k(r);t.scene.setup();t.scene.three.background=null;const $=document.getElementById("container");t.renderer=new y(r,$);t.camera=new I(r);await t.camera.controls.setLookAt(78,20,-2.2,26,-4,25);r.init();r.get(F).create(t);const v="/node_modules/fragments-beta/dist/resources/worker.mjs",e=r.get(L);e.init(v);t.camera.controls.addEventListener("rest",()=>e.core.update(!0));e.list.onItemSet.add(({value:o})=>{o.useCamera(t.camera.three),t.scene.three.add(o.object),e.core.update(!0)});const B=async()=>{const o=["/resources/frags/school_arq.frag","/resources/frags/school_str.frag"];await Promise.all(o.map(async n=>{var c;const s=(c=n.split("/").pop())==null?void 0:c.split(".").shift();if(!s)return null;const d=await(await fetch(n)).arrayBuffer();return e.core.load(d,{modelId:s})}))},A=async()=>{for(const[,o]of e.list){const n=await o.getBuffer(!1),s=new File([n],`${o.modelId}.frag`),a=document.createElement("a");a.href=URL.createObjectURL(s),a.download=s.name,a.click(),URL.revokeObjectURL(a.href)}},S=()=>{const n=[...e.list.keys()].find(s=>/arq/.test(s));n&&e.core.disposeModel(n)},U=()=>{for(const[o]of e.list)e.core.disposeModel(o)};p.init();const[u,C]=f.create(o=>{const n=async({target:m})=>{m.loading=!0,await B(),m.loading=!1};let s;e.list.size===0&&(s=l`
