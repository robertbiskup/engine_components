    ...
    <bim-panel active label="Area Measurement Tutorial" class="options-menu">
      ...
      <bim-panel-section label="Measurer">
        ...
        <bim-color-input 
          ...
          @input="${({target:t})=>{a.color=new y(t.color)}}">
        </bim-color-input>
